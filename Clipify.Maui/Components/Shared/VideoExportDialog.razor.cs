...
public partial class VideoExportDialog
{
    ...
    public async Task ExportVideo(MetaData metaData, string outputDir, string ffmpegArguments, CancellationToken? cancellationToken = null)
    {
        OutputDir = outputDir;
        _visible = true;
